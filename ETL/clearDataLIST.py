...
pasta = "E:\\00Rangel\\01Projetos\\Python\\ETL\\dados\\Diversos\\"
...
for arquivo in arquivos:
    if arquivo.endswith('.csv'):
        ...
        with open(caminho_arquivo, 'r') as arquivo_entrada, open(caminho_arquivo_saida, 'w', newline='') as arquivo_saida:
